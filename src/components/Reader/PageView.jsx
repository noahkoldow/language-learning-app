...
export function PageView() {
  ...
  // Helper function to restore original level after hold gesture
  const restoreOriginalLevel = useCallback(() => {
    if (levelBeforeHold) {
  ...
  }, [levelBeforeHold, currentLevel, currentPage, getTranslatedPage, pages, updateLevel]);
